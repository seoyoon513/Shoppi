...
class HomeBannerAdapter : ListAdapter<Banner, HomeBannerAdapter.HomeBannerViewHolder>(
    ...
    class HomeBannerViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        private val bannerTitleTextView = view.findViewById<TextView>(R.id.tv_bannder_title)
        ...
        private val bannerDetailPriceTextView = view.findViewById<TextView>(R.id.tv_banner_detail_discount_price)
